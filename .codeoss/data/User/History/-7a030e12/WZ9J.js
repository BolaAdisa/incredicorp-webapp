...
const Dashboard = () => {
          ...
          if (userDocSnap.exists()) 
 {
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}> {/* Added a container div */}
        ...
        <div> {/* Added a div to wrap the buttons */}
      ...
      <button onClick={handleViewTransactions}>Transaction History</button>
      <button onClick={handleViewTransfers}>Make Transfer</button> {/* New button for Transfers */} 
    </div>
  );
};
